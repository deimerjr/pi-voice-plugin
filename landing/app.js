...
const CUADRILLA_DATA = {
  ...
  santa: {
    ...
    text: "A ver qué hiciste, Alex... Líder, voy a auditar con lupa. Todo verificado y aprobado para el Líder.",
    pitch: 0.75,
    rate: 0.95,
    synthTone: 220,
  ...
  juan_carlos: {
    key: "juan_carlos",
    name: "Juan Carlos",
    role: "Locutor // juan_carlos",
    voiceName: "juan_carlos",
    audioFile: "audio/juan_carlos.wav",
    statusText: "Juan Carlos transmitiendo con energía...",
    text: "¡Hola Líder! Soy Juan Carlos. Las líneas están que arden, todo el equipo listo para programar.",
    pitch: 1.0,
    rate: 1.05,
    synthTone: 380,
    avatarSvg: `<polygon points="24,6 40,16 40,32 24,42 8,32 8,16"/><rect x="20" y="16" width="8" height="16" fill="currentColor"/><circle cx="24" cy="24" r="3" stroke-width="2"/>`,
  },
  valeria: {
    key: "valeria",
    name: "Valeria",
    role: "Ejecutiva // valeria",
    voiceName: "valeria",
    audioFile: "audio/valeria.wav",
    statusText: "Valeria reportando con dicción nítida...",
    text: "Hola Líder, soy Valeria. Tono ejecutivo y dicción nítida con calidad de estudio.",
    pitch: 1.1,
    rate: 1.05,
    synthTone: 480,
    avatarSvg: `<rect x="8" y="8" width="32" height="32"/><circle cx="24" cy="24" r="10" stroke-width="3"/><rect x="20" y="20" width="8" height="8" fill="currentColor"/>`,
  },
  fenrir: {
    key: "fenrir",
    name: "Fenrir",
    role: "Autoridad // fenrir_es",
    voiceName: "fenrir_es",
    audioFile: "audio/fenrir.wav",
    statusText: "Fenrir dictando con presencia profunda...",
    text: "Entendido Líder. Soy Fenrir, con presencia profunda y autoritaria en español.",
    pitch: 0.85,
    rate: 0.95,
    synthTone: 160,
    avatarSvg: `<polygon points="24,4 42,40 6,40"/><rect x="18" y="24" width="12" height="12" fill="currentColor"/><line x1="24" y1="4" x2="24" y2="40"/>`,
  },
  ximena: {
    key: "ximena",
    name: "Ximena",
    role: "Español México // ximena",
    voiceName: "ximena",
    audioFile: "audio/ximena.wav",
    statusText: "Ximena saludando con calidez mexicana...",
    text: "¡Hola Líder! Soy Ximena. Un gusto saludarte con la calidez y el acento de México.",
    pitch: 1.15,
    rate: 1.05,
    synthTone: 460,
    avatarSvg: `<circle cx="24" cy="24" r="16"/><polygon points="24,14 30,28 18,28" fill="currentColor"/><circle cx="24" cy="24" r="4" fill="none"/>`,
  },
  mateo: {
    key: "mateo",
    name: "Mateo",
    role: "Conversacional // mateo",
    voiceName: "mateo",
    audioFile: "audio/mateo.wav",
    statusText: "Mateo comentando con tono fresco...",
    text: "Hola Líder, soy Mateo. Voz masculina fresca y conversacional para el desarrollo diario.",
    pitch: 1.0,
    rate: 1.05,
    synthTone: 360,
    avatarSvg: `<rect x="10" y="10" width="28" height="28"/><line x1="10" y1="24" x2="38" y2="24"/><line x1="24" y1="10" x2="24" y2="38"/><rect x="18" y="18" width="12" height="12" fill="currentColor"/>`,
  },
};
